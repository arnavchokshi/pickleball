...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=DEFAULT_SPEED_SMOOTHING_WINDOW_FRAMES,
        help="Moving-average window over adjacent wrist-speed segments.",
    )
    ...
    if args.allow_missing and not args.skeleton3d.is_file():
        payload = build_blocked_wrist_velocity_peaks(
            ...
            speed_smoothing_window_frames=args.speed_smoothing_window_frames,
        )
    else:
