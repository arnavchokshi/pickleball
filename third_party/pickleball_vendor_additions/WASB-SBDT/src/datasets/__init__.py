...
from .pickleball import Pickleball  # pickleball addition, not upstream
from .pickleball import get_clips as get_pickleball_clips  # pickleball addition, not upstream
...
__dataset_factory = {
    ...
    'pickleball': Pickleball,  # pickleball addition, not upstream
        }
...
__video_clip_factory = {
    ...
    'pickleball': get_pickleball_clips,  # pickleball addition, not upstream
        }
