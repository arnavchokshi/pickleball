...
| w4_footattr_verify_20260707 | codex xhigh ADVERSARIAL (verdict gates commit + integration) | bg task brxa8dtar | see header | READ-ONLY + lane dir (mutates only copies) | — | ~1-2h | 2026-07-07 |
