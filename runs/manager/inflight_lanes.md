...
|---|---|---|---|---|---|---|---|
| w5_ballprep_20260707 | codex | bg bjj4sr7dh | resume: log banner session id in runs/lanes/w5_ballprep_20260707/log.txt | threed/racketsport/roboflow_corpus.py, scripts/racketsport/train_ball_pretrain.py, scripts/racketsport/train_ball_stage2.py, tests/racketsport/test_roboflow_corpus*+test_train_ball*+new contract test; wasb_adapter.py minimal shared-helper extraction only | none | ~hours (code+tests, xhigh) | 2026-07-07T22:30 |
| w5_bvpspan_20260707 | codex | bg b8fciyw0m | resume: log banner session id in runs/lanes/w5_bvpspan_20260707/log.txt | threed/racketsport/ball_arc_chain.py, ball_arc_solver.py + their bvp/junction helpers + tests | none | ~hours (gate-adjacent; verify round follows) | 2026-07-07T23:05 |
