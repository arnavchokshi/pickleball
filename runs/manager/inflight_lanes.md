...
| w6_labelingest_20260708 | codex | (see log banner) | codex exec resume (cd ROOT first) | reviewed-corpus build outputs, LoSO fold config, converter + tests | none | ~1-2h; then GPU re-score errand | 2026-07-08 13:5x |
