...
| w4_footattr_fix_20260707 | codex xhigh GATE-ADJACENT (adversarial verify follows) | bg task bw7gwdhl2 | see header | phase-producer files per Design A (placement/grounding area) + their tests; FORBIDDEN: camera_motion.py, ball_*, fenced files | — | ~2-4h | 2026-07-07 |
| w4_cammotion_fix_20260707 | codex xhigh GATE-ADJACENT (adversarial verify follows) | bg task bkqb2z298 | see header | camera_motion.py + test_camera_motion.py ONLY | — | ~1-2h | 2026-07-07 |
