...
| w6_footpinstub_20260708 | codex | (see log banner) | codex exec resume (cd ROOT first) | threed/racketsport/worldhmr.py, body_grounding_quality.py + tests | none | ~30-90min; watcher armed (untracked dispatch) | 2026-07-08 |
| w6_gate1b_harnessdiag_20260708 | codex (read-only) | (see log banner) | codex exec resume (cd ROOT first) | NOTHING (read-only; lane dir only) | none | ~30-90min; watcher armed | 2026-07-08 |
