...
|---|---|---|---|---|---|---|---|
| calv1_fusedefault_20260708 | codex | court session (bg job c922aa13) | read runs/lanes/calv1_fusedefault_20260708/{log.txt,report.json} | threed/racketsport/court_detector_v2.py, court_detector_v2_hypotheses.py, court_model_infer.py, tests/racketsport/test_court_e4_fusion.py, tests/racketsport/test_court_fusion_default.py (NEW) | none | ~1-2h | 2026-07-08 |
