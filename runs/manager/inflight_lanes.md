...
| trkL_selection_impl_20260719 | Codex gpt-5.6-sol high (queue #2+#3, P0-I fix): player-selection layers A/B/C per trkL_selection_20260717/DESIGN_selection_layer.md, registered thresholds frozen (accept 0.35/reject 0.42/2.5m/12f/0.4-0.4-0.2/S0.5); stitch veto + re-bind + interpolated:true survives export; NEW FILES ONLY | codex 019f7e07-5719-7e80-973e-f6ef722cfb5c pid 57304 | codex exec [std flags] resume 019f7e07-5719-7e80-973e-f6ef722cfb5c | NEW: player_selection.py, select_players_from_pool.py, player_selection_report_schema.json, test_player_selection.py, list_scaffold_tools.py ADDITIVE-last; READ-ONLY assoc/repair/process_video/orchestrator/MANIFEST/best_stack | none (CPU; A100 micro card-eval is manager follow-up ~$0.5) | hours; report.json + VM_EVAL_PLAN.md | 2026-07-19 manager |
| static_cal_firstlock_20260717 (impl) | Codex gpt-5.6-sol high (queue #4): implement lane spec.md exactly — single-lock static CAL + cross-frame line pooling + k1 zero-distortion fix + static-consistency guard; acceptance = spec SS4 1-5 per criterion; SOLE process_video.py owner (calibration seams only) | codex 019f7e07-5719-7632-8e2a-4cf70d6d71fd pid 57306 | codex exec [std flags] resume 019f7e07-5719-7632-8e2a-4cf70d6d71fd | court_calibration.py, court_line_keypoints.py, process_video.py CAL seams, new court_lock code/tests, lane dir; NO list_scaffold_tools/best_stack (hunks in report) | none (CPU) | hours; report.json | 2026-07-19 manager |
| trk_rfdetr_integrate_20260717 (impl) | Codex gpt-5.6-sol high (queue #6, branch 2b conf 0.18): detector-injection runner + MANIFEST rfdetr_large_2026 + best_stack rev 12->13 preview do_not_promote + kill-switch to yolo26m + NOTES-TEXT CORRECTION (ghosts = P0-I fabrication, not high-conf detections); GPU repro = NO-ATTEMPT in sandbox, VM_REPRO_PLAN.md for manager GPU session | codex 019f7e07-5719-7d30-b7d2-a6bbac30a20f pid 57308 | codex exec [std flags] resume 019f7e07-5719-7d30-b7d2-a6bbac30a20f | orchestrator.py (sole), models/MANIFEST.json, configs/racketsport/best_stack.json, RUNBOOK tracking lines, named tests, lane dir | none yet (GPU-class repro follows, ~$1-3) | hours; report.json + VM_REPRO_PLAN.md | 2026-07-19 manager |
| event_head_corpus_20260719 | Codex gpt-5.6-sol high (queue #5 CODE LEG): SCALE_UP_SPEC Levers 2+3 + fixes 1/4/5 — multi-window stride-32 extraction, 70/15/15 split rebalance by parent video, DataLoader workers, eval-window param+assert (reproduce 9TP/0FP matched-window on 07-16 ckpt), git-rev-parse guard, AppleDouble hygiene, dataloader==inference tensor parity; VM_RUN_PLAN.md for manager GPU leg (A100-40/L4/T4 ladder, cap 5h/$10) | codex 019f7e07-5719-7b01-adb7-58b3976afe32 pid 57310 | codex exec [std flags] resume 019f7e07-5719-7b01-adb7-58b3976afe32 | threed/racketsport/event_head/**, eval_event_head.py, train_event_head.py, their tests, lane dir | none (CPU; train GPU leg follows) | hours; report.json + VM_RUN_PLAN.md | 2026-07-19 manager |
