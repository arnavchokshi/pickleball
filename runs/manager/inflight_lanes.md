...
|---|---|---|---|---|---|---|---|
| calv1_e4fusion_20260708 | codex | court session (bg job c922aa13) | read runs/lanes/calv1_e4fusion_20260708/{log.txt,report.json} | threed/racketsport/court_model_infer.py, court_detector_v2.py, court_detector_v2_hypotheses.py, tests/racketsport/test_court_e4_fusion.py (NEW) | none | ~1-2h | 2026-07-08 |
| calv1_impact_20260708 | codex | court session (bg job c922aa13) | read runs/lanes/calv1_impact_20260708/{log.txt,report.json} | ALL NEW: threed/racketsport/court_cal_impact.py, scripts/racketsport/court_calibration_impact_harness.py, tests/racketsport/test_court_cal_impact.py | none | ~1-2h | 2026-07-08 |
...
| w6_footpinstub_20260708 | codex | (see log banner) | — | threed/racketsport/worldhmr.py, body_grounding_quality.py + tests | none | DONE PASS 2026-07-08 (validator-complete stub + fixture regression) | 2026-07-08 |
