...
|---|---|---|---|---|---|---|---|
| calv1_wavea_land_20260708 | codex | court session (bg job c922aa13) | read runs/lanes/calv1_wavea_land_20260708/{log.txt,report.json} | Wave A solver set: threed/racketsport/court_{detector_v2*,keypoint_net,line_bank,model_infer,proposals,synth_scenes,synth_stream,template_competition,finding_technology_benchmark}.py, scripts/racketsport/{evaluate_court_model_v2,generate_synthetic_court_keypoints,render_court_detector_v2_multiframe_overlays,train_court_model_v2}.py, 7 tests/racketsport court tests, server/court_review.py (conditional) | none | ~1-2h | 2026-07-08 |
...
| w6_cvatimport_20260708 | sonnet-local | agent (this session) | SendMessage if stalled | NOTHING in repo (CVAT import + API verify; optional logs in own lane dir) | none | ~30-90min | 2026-07-08 |
