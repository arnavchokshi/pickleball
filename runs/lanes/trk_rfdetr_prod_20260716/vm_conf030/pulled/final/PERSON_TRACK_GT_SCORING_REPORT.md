...
| `conf030_out/scored/rfdetr_l_conf030` | `do_not_promote` | 2 | 0.8507 | 0.7780 | 0.8522 | 0.7782 | 2 | 322 | 73 | 0.8308 | 0.6767 | n/a | missing_gt_detections | burlington_gold_0300_low_steep_corner:spectator_or_background_false_positives_present, burlington_gold_0300_low_steep_corner:off_court_false_positives_present, wolverine_mixed_0200_mid_steep_corner:idf1_below_0.85, wolverine_mixed_0200_mid_steep_corner:id_switches_present, wolverine_mixed_0200_mid_steep_corner:spectator_or_background_false_positives_present, wolverine_mixed_0200_mid_steep_corner:off_court_false_positives_present, wolverine_mixed_0200_mid_steep_corner:four_player_coverage_below_0.95 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `conf030_out/scored/arm0a_repro` | `do_not_promote` | 0 | 0.0942 | 234 | 0 | 0.7117 | burlington_gold_0300_low_steep_corner:four_player_coverage_below_0.95, wolverine_mixed_0200_mid_steep_corner:four_player_coverage_below_0.95, wolverine_mixed_0200_mid_steep_corner:near_miss_false_positive_rate_above_0.10 |
| `conf030_out/scored/rfdetr_l_conf030` | `do_not_promote` | 16 | 0.0878 | 241 | 0 | 0.6767 | wolverine_mixed_0200_mid_steep_corner:idf1_below_0.85, wolverine_mixed_0200_mid_steep_corner:id_switches_present, wolverine_mixed_0200_mid_steep_corner:true_spectator_or_background_false_positives_present, wolverine_mixed_0200_mid_steep_corner:four_player_coverage_below_0.95, wolverine_mixed_0200_mid_steep_corner:near_miss_false_positive_rate_above_0.10 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | --- |
| `conf030_out/scored/arm0a_repro` | burlington_gold_0300_low_steep_corner | 0.8831 | 0.8892 | 0.7906 | 1.0000 | 0.7746 | 0 | 184 | 357 | 29 | 0.7117 | 427/600 | 32.3344 | 4 | missing_gt_detections | `conf030_out/scored/burlington_gold_0300_low_steep_corner/arm0a_repro/tracks.json` |
| `conf030_out/scored/arm0a_repro` | wolverine_mixed_0200_mid_steep_corner | 0.8516 | 0.8611 | 0.7415 | 1.0000 | 0.7133 | 0 | 131 | 213 | 67 | 0.7600 | 228/300 | 29.8026 | 4 | missing_gt_detections | `conf030_out/scored/wolverine_mixed_0200_mid_steep_corner/arm0a_repro/tracks.json` |
| `conf030_out/scored/rfdetr_l_conf030` | burlington_gold_0300_low_steep_corner | 0.9234 | 0.9261 | 0.8577 | 1.0000 | 0.8471 | 0 | 179 | 188 | 30 | 0.9850 | 591/600 | n/a | 4 | missing_gt_detections | `conf030_out/scored/burlington_gold_0300_low_steep_corner/rfdetr_l_conf030/tracks.json` |
| `conf030_out/scored/rfdetr_l_conf030` | wolverine_mixed_0200_mid_steep_corner | 0.7780 | 0.7782 | 0.7074 | 0.8562 | 0.6708 | 2 | 143 | 250 | 43 | 0.6767 | 203/300 | n/a | 4 | missing_gt_detections | `conf030_out/scored/wolverine_mixed_0200_mid_steep_corner/rfdetr_l_conf030/tracks.json` |
...
| --- | --- | --- | --- | ---: | ---: | ---: |
| `conf030_out/scored/arm0a_repro` | burlington_gold_0300_low_steep_corner | 0-599 | 0-599 | 0 | 0 | 0 |
| `conf030_out/scored/arm0a_repro` | wolverine_mixed_0200_mid_steep_corner | 0-299 | 0-299 | 0 | 0 | 0 |
| `conf030_out/scored/rfdetr_l_conf030` | burlington_gold_0300_low_steep_corner | 0-599 | 0-599 | 0 | 0 | 0 |
| `conf030_out/scored/rfdetr_l_conf030` | wolverine_mixed_0200_mid_steep_corner | 0-299 | 0-299 | 0 | 0 | 0 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `conf030_out/scored/rfdetr_l_conf030` | wolverine_mixed_0200_mid_steep_corner | 55 | 2 | 3 | 4 | 49 | 6 | 0.5042 |
| `conf030_out/scored/rfdetr_l_conf030` | wolverine_mixed_0200_mid_steep_corner | 83 | 4 | 4 | 3 | 41 | 42 | 0.5725 |
