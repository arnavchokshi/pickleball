...
3. Deterministic NEXT corpus revision: base = the 1,750-row corpus (runs/lanes/w7_ballingest2_20260709/reviewed_corpus/, md5 0bb2fc592361f2e9246a71701617c3e5, read-only) + new rows -> runs/lanes/w7_ballingest3_20260709/reviewed_corpus/ + byte-identical-rerun manifest + NEW md5. REPORT THE TOTAL ROW COUNT PROMINENTLY (the owner believes we cross 3,000 — the number decides whether the 3k checkpoint fires tonight).
...
## REPORT
Self-write runs/lanes/w7_ballingest3_20260709/report.json (lane_report.schema.json structure): protected row FIRST, TOTAL CORPUS N headline, accounting, md5s, LoSO proof, BEST-STACK DELTA none, honest_issues, next.
