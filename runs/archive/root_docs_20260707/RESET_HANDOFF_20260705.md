...
- P3-A anchor-first BVP solver: **landed as documented WIP** (court-volume gates, endpoint-corridor
  refinement — out-of-court arc fits impossible by construction; finish-line steps in §8). P2 arc
