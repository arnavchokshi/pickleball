...
| `pbvision_gallery_20260719` | pb.vision gallery and owner-provided demo | 124,743 labels | ✅ used (training) | After the approximately 10-frame owner-tap spot-check, add only the seven partitions.train pseudo-label IDs 143sf3gdwxsa, 98z43hspqz13, bewqc0glhgpq,… |
