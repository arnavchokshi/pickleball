...
| ball | WASB, TrackNetV3 family, audio onset, bounce/in-out, event fusion, default 3D arc chain | runtime/tooling and reviewed-label utilities exist; stage-2 sparse-review trainer/SST manifests/disagreement CLIs landed (5b268aa6d; `runs/lanes/w4_ballcode_20260707/report.json`); ballgpu banked harness_v0 NON-PROMOTABLE cards: official control healthy 0.7143/0.7826, stage-1 bridge 0.8936/0.2000, seed fine-tune 0.7368/0.5946 with best hidden-FP 0.20, SST-3k 0.7442/0.7273 with recall 0.7708, threshold sweep banked, 12,075-row disagreement queue, protected-hash 35/0 (28c9244bd; `runs/lanes/w4_ballgpu_20260707/REPORT.md`); BVP STEP 1 is PARTIAL: real LOO refit now passes, but protected-span preservation failed and Magnus stays gated behind STEP 1 (5633c4b48; `runs/lanes/w4_bvp_20260707/report_r3.json`) | checkpoints/candidates are contextual until a gate passes; local WASB anchor sha256 9d391239ab10c733f8e5bfadf16ab72838e7a8ebc88e8ae2038501c03d42b4bb is verified on VM and Mac (28c9244bd; `runs/lanes/w4_ballgpu_20260707/REPORT.md`) | yes, with reuse, confidence-banded display, and fail-closed arc sanity; img1605 ball-arc census is empty in the fresh compensated run, 0 segments and 0/297 world frames, with diagnosis queued for wave 5 (a93764203; `runs/lanes/w4_freshproof_20260707/summary.json`) | reviewed ball F1, bounce/contact timing, in/out agreement | partial reviewed labels exist; acceptance gates have not passed; ballgpu cards are harness_v0 measurement mode, small-N, and not promotion candidates until wave-5 preprocessing alignment/retrain/re-score in official mode (28c9244bd; `runs/lanes/w4_ballgpu_20260707/REPORT.md`) | SCAFFOLD, not VERIFIED |
| body | Fast SAM-3D-Body, body-frame scheduler, grounding refinement, mesh index export | remote/local BODY paths, mesh index artifacts, speed improvements, visual smoothing, and camera-motion AUTO decode-orientation telemetry exist for scoped clips; decisive fresh-GPU proof at committed 940576495 is GREEN 4/4 with `max_foot_lock_slide_m` 0.02025/0.02004/0.01798/0.02307, root jumps 0/0/0/0, body_full_clip_gate 4/4, browser assertion_errors [] x4, and pipeline_status complete x4 (a93764203; `runs/lanes/w4_freshproof_20260707/summary.json`) | runtime configuration is explicit; candidate-label review is not GT; payload-collapse accuracy isolation is not clean yet | yes, writes BODY/world contracts when inputs exist; BODY dispatch now requires explicit remote host and version stamps hash committed blobs (dcc4dae42; 190dea09f; `runs/lanes/w4_fleethosts_20260707/report.json`; `runs/lanes/w4_syncstamp_20260707/report.json`); camera_motion_auto is ON for img1605 at 50.02 > 2.5 and OFF for statics at 0.129/0.524/0.385-0.568 with first-class decode_orientation_* keys present x4 (a93764203; `runs/lanes/w4_freshproof_20260707/summary.json`) | independent-GT world-MPJPE | external/candidate paths have not produced a promotion; visual metrics are scoped review evidence; H100 BODY is runtime-validated only, not quality-verified (runs/lanes/w4_h100body_20260707/REPORT.md) | SCAFFOLD, not VERIFIED |
