...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "PickleballCapture", dependencies: ["PickleballCore"], path: "Capture/Sources/PickleballCapture"),
        ...
        .target(name: "PickleballReplay", dependencies: ["PickleballCore", "PickleballFastTier"], path: "Replay/Sources/PickleballReplay"),
        ...
        .testTarget(name: "PickleballReplayTests", dependencies: ["PickleballReplay"], path: "Replay/Tests/PickleballReplayTests"),
    ]
)
