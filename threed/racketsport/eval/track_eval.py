...
from threed.racketsport.eval.label_checks import score_player_bbox_labels
...
def _evaluate_ready_clip(clip_name: str, *, run_dir: Path, labels_dir: Path) -> EvalClipResult:
    ...
    label_metrics, notes = score_player_bbox_labels(labels_dir=labels_dir, tracks=tracks)
